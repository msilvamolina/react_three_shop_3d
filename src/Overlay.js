      ...
      <div className="section--container">
        <div className="support--content">
          <div>
            ...
            >
              CUSTOMIZAR <AiOutlineHighlight size="1.3em" />
            </button>
          </div>
        </div>
      </div>
      ...
      <motion.section {...config}>
        <div className="customizer">
          ...
          <div className="models">
            ...
            {selectedIndex === 0 && (
              <ButtonGroupDropdown
                onOptionsChange={onOptionsChangeMan}
                text={false}
                options={optionsMan}
                selectedIndex={selectedManIndex}
              />
            )}
            {selectedIndex === 1 && (
              <ButtonGroupDropdown
                onOptionsChange={onOptionsChangeWoman}
                text={false}
                options={optionsWoman}
                selectedIndex={selectedWomanIndex}
              />
            )}
            {selectedIndex === 2 && (
              <ButtonGroupDropdown
                onOptionsChange={onOptionsChangeKid}
                text={false}
                options={optionsKid}
                selectedIndex={selectedKidIndex}
              />
            )}
          </div>
          <button
